...
export default function TShirtProductPage() {
  ...
  return (
    <main className="min-h-screen bg-[#f7f7f5] text-black">
      <header className="sticky top-0 z-40 flex h-16 items-center justify-between border-b border-black/10 bg-[#f7f7f5]/95 px-4 backdrop-blur-md sm:px-8 lg:px-12"><Link href="/tshirts" className="text-[10px] font-bold uppercase tracking-[.16em]">&larr; T-shirts</Link><Link href="/" className="text-[15px] font-black tracking-[-.08em]">DRIP<span className="font-normal">NALITY</span><sup className="ml-0.5 text-[6px]">&reg;</sup></Link><div className="flex gap-4"><Link href="/bag" className="text-[10px] font-bold uppercase tracking-[.16em]">Bag</Link><Link href="/account" className="text-[10px] font-bold uppercase tracking-[.16em]">Account</Link></div></header>
      <section className="mx-auto max-w-[1560px] px-3 py-3 sm:px-6 sm:py-6 lg:grid lg:grid-cols-[minmax(0,1.22fr)_minmax(340px,.78fr)] lg:gap-10 lg:px-10 lg:py-10">
        ...
        <aside className="px-3 py-10 sm:px-5 lg:sticky lg:top-16 lg:h-fit lg:px-0 lg:py-3">
          ...
          <h1 className="mt-7 text-[clamp(2.8rem,5vw,5.5rem)] font-black leading-[.79] tracking-[-.09em] uppercase">Oversized<br />Multi-Balaclavas<br />White T-Shirt</h1><p className="mt-6 text-[16px] font-bold">60 TND</p>
          ...
          <dl className="mt-8 grid grid-cols-2 gap-x-5 gap-y-5 border-y border-black/10 py-5 text-[10px] font-bold uppercase tracking-[.12em]"><div><dt className="text-black/45">Delivery</dt><dd className="mt-1">8 TND / Tunisia</dd></div><div><dt className="text-black/45">Payment</dt><dd className="mt-1">Cash on delivery</dd></div><div><dt className="text-black/45">Fit</dt><dd className="mt-1">Oversized</dd></div><div><dt className="text-black/45">Release</dt><dd className="mt-1">Drop 02</dd></div></dl>
