    ...
    <main className="min-h-screen bg-[#f7f7f5] text-black">
      ...
      <section className="mx-auto max-w-[1560px] px-3 py-3 sm:px-6 sm:py-6 lg:grid lg:grid-cols-[minmax(0,1.22fr)_minmax(340px,.78fr)] lg:gap-10 lg:px-10 lg:py-10">
        ...
        <aside className="px-3 py-10 sm:px-5 lg:sticky lg:top-16 lg:h-fit lg:px-0 lg:py-3">
          ...
          <h1 className="mt-7 text-[clamp(2.8rem,5vw,5.5rem)] font-black leading-[.79] tracking-[-.09em] uppercase">Oversized<br />Multi-Balaclavas<br />White T-Shirt</h1><p className="mt-6 text-[16px] font-bold">59 TND</p>
          ...
          <div className="mt-8 grid gap-2"><button onClick={buyNow} className="flex h-11 w-full items-center justify-between border border-black px-4 text-[9px] font-medium uppercase tracking-[.13em] transition hover:bg-black hover:text-white">Buy now / 67 TND <span>&nearr;</span></button><button onClick={addToBag} className="flex h-11 w-full items-center justify-between border border-black/25 px-4 text-[9px] font-medium uppercase tracking-[.13em] transition hover:border-black">Add to bag <span>+</span></button></div>
