...
export default function TShirtProductPage() {
  ...
  return (
    <main className="min-h-screen bg-[#f7f7f5] text-black">
      <header className="sticky top-0 z-40 border-b border-black/10 bg-[#f7f7f5]/95 backdrop-blur-md"><div className="mx-auto grid h-16 max-w-[1600px] grid-cols-[1fr_auto_1fr] items-center px-3 sm:px-8 lg:px-12"><nav className="hidden gap-6 md:flex"><Link href="/tshirts" className="text-[9px] font-bold tracking-[.14em]">T-SHIRTS</Link><Link href="/support" className="text-[9px] font-bold tracking-[.14em]">SUPPORT</Link></nav><Link href="/" className="text-[15px] font-black tracking-[-.08em]">DRIP<span className="font-normal">NALITY</span><sup className="ml-0.5 text-[6px]">&reg;</sup></Link><div className="ml-auto flex items-center gap-1 sm:gap-2"><Link href="/tshirts" className="grid size-8 place-items-center" aria-label="Search collection"><SearchIcon/></Link><Link href="/wishlist" className="grid size-8 place-items-center" aria-label="Saved pieces"><HeartIcon/></Link><Link href="/account" className="grid size-8 place-items-center" aria-label="Account"><AccountIcon/></Link><Link href="/bag" className="flex items-center gap-1 text-[10px] font-bold tracking-[.13em]" aria-label="Shopping bag"><span className="hidden sm:inline">BAG</span><BagIcon/><span>(0)</span></Link></div></div></header>
