...
export default function Home() {
  ...
  const results = catalogProducts.filter((product) => product.name.toLowerCase().includes(query.trim().toLowerCase()));
