...
function CheckoutContent() {
  ...
  useEffect(() => {
    const loadSession = async () => {
      ...
      if (!session?.user || !session.access_token) { window.location.assign('/account'); return; }
