...
export default function GlobalBrandSwitcher() {
  ...
  return (
    <Link href="/" aria-label="DRIPNALITY home" className="global-brand-switcher fixed left-1/2 top-2 z-[60] grid h-10 w-[128px] -translate-x-1/2 place-items-center overflow-hidden sm:top-3">
      <span className="brand-logo-cycle absolute grid size-9 place-items-center overflow-hidden">
        <Image src="/klk.png" alt="" fill unoptimized sizes="36px" className="scale-[2.05] object-contain brightness-0" />
      </span>
